# -*- coding: utf-8 -*-
"""
Created on Tue Jul 28 13:15:52 2026
...
from instruments.powermeter_HAL_v1 import HP437BPowerMeter

from feedback_control.optimizer_max import optimize_step_fd_adaptive

import numpy as np


PAUSE_FLAG = 'D:/cvqkd/1_data/flags/pause_bob.flag'
# --------------------------------------------------------------------------
...
RESOURCE_ADDRESS = "GPIB1::13::INSTR"

SERIAL_A = "210321A35FBA"

SERIAL_B = "210321B21C43"
...
meter = HP437BPowerMeter(RESOURCE_ADDRESS)
...
ax.set_title("Live plot of HP437B PowerMeter")
...
def on_key(event):
    ...
    if event.key == 'q':
        ...
        print(f"\n>>> Key '2' pressed - {state} voltage updates <<<\n")
...
def update(frame):
    global V, LAST_POWER, _frame,ALPHA
...
ani = FuncAnimation(
    ...
    interval=10,          # run as fast as the hardware allows
...
dirname = 'D:/cvqkd/1_data/polarization_stabilization_bob/'
fname = f'pol_stabilization_bob_{timestamp}.npz'
